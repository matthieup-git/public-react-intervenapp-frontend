...
function ReportCardDetails({ onModifyChange, alertIsVisible }) {
  ...
  const createdBy = rapportInStore.createdBy?.lastname.slice(0, 1).toUpperCase() + rapportInStore.createdBy?.lastname.slice(1).toLowerCase() + " " + rapportInStore.createdBy?.firstname.slice(0, 1).toUpperCase() + rapportInStore.createdBy?.firstname.slice(1).toLowerCase();
